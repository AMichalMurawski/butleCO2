...
const advantagesIcons = [
  ['truck', 'Szybka dostawa pod drzwi'],
  ['user-check', 'Obsługa klientów indywidualnych i firm'],
  ['calendar', 'Elastyczne zamówienia'],
  ['bubbles', 'Fachowe doradztwo'],
  ['checkmark', 'Bezpieczne i certyfikowane produkty'],
];
