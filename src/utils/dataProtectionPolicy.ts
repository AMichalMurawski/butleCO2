...
export const dataProtectionPolicy: DocumentProps[] = [
  [DocumentTextType.Title, 'Zasady ochrony danych'],
  [DocumentTextType.Subtitle, 'Rozdział 1'],
  [
  ...
  [DocumentTextType.Subtitle, 'Rozdział 2'],
  [
    DocumentTextType.Paragraph,
  ...
  [DocumentTextType.Subtitle, 'Rozdział 3'],
  [
    DocumentTextType.Paragraph,
